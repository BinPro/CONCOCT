#CONCOCT 0.3.2 [![Build Status](https://travis-ci.org/BinPro/CONCOCT.png?branch=master)](https://travis-ci.org/BinPro/CONCOCT)#
...
<b>binnisb/concoct_0.3.2</b> contains CONCOCT and all its dependencies for the [complete worklfow](doc/complete_example.md). Currently it does not do SCG evaluation.
...
```
sudo docker run -v /home/USER/Data:/opt/Data -i -t binnisb/concoct_0.3.2 bash
```
To test concoct you can then do:
```
$ cd /opt/CONCOCT-0.3.2
$ nosetests
```
